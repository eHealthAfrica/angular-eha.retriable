module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      scripts: {
        ...
        rename: function(dest, src) {
          return dest + src.replace('scripts','retriable');
        }
      }
    },
    concat: {
    ...
    uglify: {
      dist: {
        files: {
          'dist/retriable.template.min.js': ['.tmp/scripts.template.js'],
          'dist/retriable.min.js': ['.tmp/scripts.js']
        }
      }
    },
    html2js: {
